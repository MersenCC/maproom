<?php 
	...
	$_ENV['PROJECT_NAME'] = "MapRoom";
	$_ENV["PROJECT_DESCRIPTION"] = "Estas perdido ? Maproom te guia.";
	$_ENV["PROJECT_AUTHOR"] = "MapRoom";
	$_ENV["PROJECT_AUTHOR_CONTACT"] = "maproom01@gmail.com";
	$_ENV["PROJECT_URL"] = "http://localhost/MapRoom/landing";
	$_ENV["PROJECT_KEYWORDS"] = "maproom MapRoom tecnologia mapas control dispositivos";
	...
	$_ENV["MAILER_REMITENTE"] = 'maproom01@gmail.com'; // <=== Correo de la app
	$_ENV["MAILER_NOMBRE"] = 'MapRoom'; // <=== Nombre que aparece en el correo
